...
func main() {
	...
	params := decodo.NewMobileParams()
	params.URL = decodo.Ptr("https://suchen.mobile.de/fahrzeuge/search.html?dam=false&isSearchRequest=true&ref=quickSearch&s=Car&vc=Car")
